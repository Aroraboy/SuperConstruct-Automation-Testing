...
async function globalSetup() {
  ...
  const skipProjects = ['registration', 'auth', 'gc-register', 'gc-project', 'gc-invite', 'gc-accept', 'gc-add-to-project', 'gc-members-accept-project', 'gc-invite-owner', 'gc-owner-accept', 'sov-gc-login', 'sov-create', 'sov-owner-login', 'sov-approve'];
  if (
